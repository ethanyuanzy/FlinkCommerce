...
/**
 * The {@code DataStreamJob} class sets up a real-time data streaming pipeline using Apache Flink.
 * It reads financial transaction data from a Kafka topic, performs aggregations, stores raw and
 * processed results into a PostgreSQL database, and indexes transactions into Elasticsearch.
 *
 * <p>This class:
 * <ul>
 *   <li>Consumes JSON transaction data from a Kafka topic.</li>
 *   <li>Writes transaction data to a PostgreSQL table.</li>
 *   <li>Performs aggregations to compute sales per category, per day, and per month.</li>
 *   <li>Stores aggregate results into corresponding PostgreSQL tables.</li>
 *   <li>Indexes transactions into an Elasticsearch index for search and analytics.</li>
 * </ul>
 *
 * <p>Tables created/used:
 * <ul>
 *   <li>transactions</li>
 *   <li>sales_per_category</li>
 *   <li>sales_per_day</li>
 *   <li>sales_per_month</li>
 * </ul>
 *
 * <p>Requirements:
 * <ul>
 *   <li>Kafka broker running at {@code localhost:9092}</li>
 *   <li>PostgreSQL instance at {@code jdbc:postgresql://localhost:5432/postgres}</li>
 *   <li>Elasticsearch instance at {@code localhost:9200}</li>
 * </ul>
 */
public class DataStreamJob {
    ...
    private static final int executionBatchSize = 1000;
    private static final int executionBatchInterval = 200;
    private static final int executionMaxRetries = 5;

    /**
     * Main method that sets up and executes the Flink streaming job.
     *
    ...
    public static void main(String[] args) throws Exception {
        ...
        JdbcExecutionOptions execOptions = new JdbcExecutionOptions.Builder()
                .withBatchSize(executionBatchSize)
                .withBatchIntervalMs(executionBatchInterval)
                .withMaxRetries(executionMaxRetries)
                .build();
